...
def play_audio_and_display_image(word):
    ...
    # Block until the audio finishes
    while pygame.mixer.music.get_busy():
        root.update()  # Keeps the GUI responsive

    # Unload the audio file after playback finishes
    pygame.mixer.music.unload()

    # Load and display the associated image
    image_file = os.path.join("C:\\Users\\jervi\\PycharmProjects\\PD_YOLO\\word_images", f"{word}.png")
...
trained_model = YOLO("C:\\Users\\jervi\\PycharmProjects\\PD_YOLO\\YOLO_best_model.pt")
