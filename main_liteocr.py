...
def process_image():
    ...
    for i, box in enumerate(boxes):
        ...
        # Perform OCR using LiteOCR
        ocr_results = lite_ocr.read_text(binary_img)
        letter = ocr_results[0]['text'].strip().upper() if ocr_results else "X"
